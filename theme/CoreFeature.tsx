            ...
            <div className="max-w-screen-xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-10 mt-10">
                    ...
                    <div className="max-w-md text-left">
                        <h3
                            className={`text-lg font-semibold mb-6 ${isDark ? 'text-white/60' : 'text-[#767A7F]'
                                }`}
                        >
                            {current.title}
                        </h3>
                            ...
                            <div className="flex gap-2">
                                {currentList.map((_, i) => (
                                    <span
                                        ...
                                        className={`w-[6px] h-[6px] rounded-full cursor-pointer transition-colors ${i === currentIndex ? 'bg-blue-500' : 'bg-gray-300'
                                            }`}
