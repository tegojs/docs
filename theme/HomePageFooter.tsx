            ...
            <div className="flex-1 md:flex-[2] flex flex-wrap md:justify-end gap-5 md:gap-10 mr-[10%]">
                <div className="min-w-[150px] mb-5">
                    <ul className="flex flex-col gap-5 list-none p-0 m-0">
                        ...
                        <li>
                            <a href="https://apps.tachybase.com/" className={`${linkStyle} no-underline font-medium`}>
                                {content.explore}
                            </a>
                        </li>
                        <li>
                            <a href="/guides/start/introduction" className={`${linkStyle} no-underline font-medium`}>
                                {content.manual}
                            </a>
                        </li>
                    </ul>
