  ...
  },
  {
    ...
    functions: [
      ...
      },
      {
        ...
        result:
          'Error: Unexpected type of argument in function slu (expected: SparseMatrix, actual: Array, index: 0)',
        definition: {
  ...
  },
  {
    ...
    functions: [
      ...
      },
      {
        ...
        call: "subset(['a','b','c'], 1)",
        result:
          'Error: Unexpected type of argument in function subset (expected: Index, actual: number, index: 1)',
        definition: {
    ...
    functions: [
      {
        ...
        result:
          'Error: Unexpected type of argument in function map (expected: Array or Matrix, actual: number, index: 0)',
        definition: {
    ...
    functions: [
      {
        ...
        call: "to(5, 'cm')",
        result:
          'Error: Unexpected type of argument in function to (expected: Array or DenseMatrix or Matrix, actual: identifier | string, index: 1)',
        definition: {
